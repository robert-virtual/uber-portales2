...
<body style="overflow-y:hidden;background:linear-gradient(to right, #55efc4 , #0d6efd);">
    <h1 style="margin:auto;text-align:center;color:white;position:absolute;left:37%;top:10%">Uber Administracion</h1>
    <main class="m-4 h-100 d-flex flex-column justify-content-center align-items-center">
        
        <form style="background:white" class="d-flex flex-column p-4 rounded" action="/login/entrar" method="post">
